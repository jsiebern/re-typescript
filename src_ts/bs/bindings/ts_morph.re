...
module Type = {
  ...
  [@bs.send]
  external getBaseTypeOfLiteralType: t => option(t) =
  ...
  [@bs.send]
  external getAliasTypeArguments: t => option(array(t)) =
    "getAliasTypeArguments";
  [@bs.send] external getBaseTypes: t => option(array(t)) = "getBaseTypes";
  [@bs.send]
  external getIntersectionTypes: t => option(array(t)) =
...
module Project = {
  ...
  [@bs.send]
  external createSourceFile: (t, string, string) => SourceFile.t =
    "createSourceFile";
  [@bs.send]
  external getPreEmitDiagnostics: t => array(Diagnostics.t) =
    "getPreEmitDiagnostics";
  [@bs.send]
  external formatDiagnosticsWithColorAndContext:
    (t, array(Diagnostics.t)) => string =
