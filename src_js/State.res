...
let config = Recoil.atom({key: "config", default: Utils.config})
let config_open = Recoil.atom({key: "config_open", default: false})
let examples_open = Recoil.atom({key: "examples_open", default: false})

// --- Config elements
let suppress_warning_for_extended_records = Recoil.selectorWithWrite({
  key: "suppress_warning_for_extended_records",
  get: ({get}) => get(config).suppress_warning_for_extended_records,
  set: ({get, set}, value) => {
    set(config, {...get(config), suppress_warning_for_extended_records: value})
  },
})
let omit_extended_unreferenced_records = Recoil.selectorWithWrite({
  key: "omit_extended_unreferenced_records",
  get: ({get}) => get(config).omit_extended_unreferenced_records,
  set: ({get, set}, value) => {
    set(config, {...get(config), omit_extended_unreferenced_records: value})
  },
})
let generate_parser = Recoil.selectorWithWrite({
  key: "generate_parser",
...
let generate_serializer = Recoil.selectorWithWrite({
...
let array_mode = Recoil.selectorWithWrite({
  key: "array_mode",
...
let number_mode = Recoil.selectorWithWrite({
  key: "number_mode",
...
let intersection_objects = Recoil.selectorWithWrite({
...
let intersection_unions = Recoil.selectorWithWrite({
...
let intersection_classes = Recoil.selectorWithWrite({
...
let intersection_functions = Recoil.selectorWithWrite({
...
let intersection_other = Recoil.selectorWithWrite({
...
let intersection_tuple_members_optional = Recoil.selectorWithWrite({
...
let output_type = Recoil.selectorWithWrite({
  key: "output_type",
...
let bs_string_variant_mode = Recoil.selectorWithWrite({
...
let bs_number_variant_mode = Recoil.selectorWithWrite({
...
let bs_number_value = Recoil.selectorWithWrite({
  key: "bs_number_value",
  get: ({get}) =>
    switch get(config).bucklescript_config.number_variant_mode {
    | #Variant(a) | #PolyVariant(a) | #BsInline(a) => a
    },
  set: ({get, set}, value) => {
    let c = get(config)
    set(
      ...
      {
        {
          ...
          bucklescript_config: {
            ...c.bucklescript_config,
            number_variant_mode: switch c.bucklescript_config.number_variant_mode {
...
let bs_mixed_variant_mode = Recoil.selectorWithWrite({
